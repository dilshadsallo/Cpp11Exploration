...
\subsubsection{EnumerationImplicit.cpp}
\label{sub:EnumerationImplicit}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/EnumerationImplicit.cpp}

\subsubsection{Enumeration.cpp}
\label{sub:Enumeration}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/Enumeration.cpp}

\subsubsection{EnumerationConflict.cpp}
\label{sub:EnumerationConflict}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/EnumerationConflict.cpp}
...
\subsubsection{UniformArray.cpp}
\label{sub:UniformArray}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/UniformArray.cpp}

\subsubsection{UniformDynamicArray.cpp}
\label{sub:UniformDynamicArray}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/UniformDynamicArray.cpp}

\subsubsection{UniformObjectReturn.cpp}
\label{sub:UniformObjectReturn}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/UniformObjectReturn.cpp}

\subsubsection{UniformNarraw.cpp}
\label{sub:UniformNarraw}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/UniformNarrow.cpp}

\subsubsection{UniformInitializationVector.cpp}
\label{sub:UniformInitializationVector}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/UniformInitializationVector.cpp}

\subsubsection{InitializerListConstructor.cpp}
\label{sub:InitializerListConstructor}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/InitializerListConstructor.cpp}

\subsubsection{InitializerListFunction.cpp}
\label{sub:InitializerListFunction}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/InitializerListFunction.cpp}

\subsubsection{RangeForArray.cpp}
\label{sub:RangeForArray}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/RangeForArray.cpp}

\subsubsection{RangeInitializerList.cpp}
\label{sub:RangeInitializerList}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/RangeInitializerList.cpp}

\subsubsection{RangeForVector.cpp}
\label{sub:RangeForVector}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/RangeForVector.cpp}

\subsubsection{RangeForUniform.cpp}
\label{sub:RangeForUniform}
\lstinputlisting{../CoreLanguage/UsabilityEnhancements/RangeForUniform.cpp}

\subsubsection{DelegatingConstructor.cpp}
\label{sub:DelegatingConstructor}
...
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/DefaultAccessibility.cpp}

\subsubsection{MoveOnly.cpp}
\label{sub:MoveOnly}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/MoveOnly.cpp}

\subsubsection{DeleteNew.cpp}
\label{sub:DeleteNew}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/DeleteNew.cpp}

\subsubsection{OverloadedMethod.cpp}
\label{sub:OverloadedMethod}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/OverloadedMethod.cpp}

\subsubsection{UserLiteralRaw.cpp}
\label{sub:UserLiteralRaw}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/UserLiteralRaw.cpp}

\subsubsection{UserCookedObject.cpp}
\label{sub:UserCookedObject}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/UserCookedObject.cpp}

\subsubsection{UserCookedLiterals.cpp}
\label{sub:UserCookedLiterals}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/UserCookedLiterals.cpp}

\subsubsection{UserCookedString.cpp}
\label{sub:UserCookedString}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/UserCookedString.cpp}

\subsubsection{AssertNamespace.cpp}
\label{sub:AssertNamespace}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/AssertNamespace.cpp}

\subsubsection{AssertClass.cpp}
\label{sub:AssertClass}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/AssertClass.cpp}

\subsubsection{AssertTypeSame.cpp}
\label{sub:AssertTypeSame}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/AssertTypeSame.cpp}

\subsubsection{AssertTypeFloat.cpp}
\label{sub:AssertTypeFloat}
\lstinputlisting{../CoreLanguage/FunctionalityImprovements/AssertTypeFloat.cpp}
\end{appendix}
